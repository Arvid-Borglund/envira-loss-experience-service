...
- Currency: premiums at the inception month's rate, claims at the loss month's; a missing rate excludes and counts the row (none missing here). Ranking: loss ratio descending, then incurred loss.
